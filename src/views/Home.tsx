    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="text-center">
        ...
        <div className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-blue-600 mb-2">¿Quieres realizar una falla vehicular?</h2>
            <p className="text-gray-700 mb-4">Inicia el proceso de falla vehicular</p>
            <Link to="/fallas" className="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors duration-300">
              Ir a Registro de falla
            </Link>
          </div>
        </div>
